import { Box, Button, Container, Grid, makeStyles, MenuItem, TextField, Typography } from '@material-ui/core';
...
function CreateProduct(props) {
    ...
    const [sizes, setSizes] = useState(["Không có size nào!"]);
        ...
        <Container disableGutters={true}>
            ...
            <Grid container spacing={1}>
                <Grid item sm={12} md={6}>
                    <Box border="1px solid gray" borderRadius="8px">
